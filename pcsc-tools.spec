...
Source0  : https://pcsc-tools.apdu.fr/pcsc-tools-1.7.2.tar.bz2
Source1  : https://pcsc-tools.apdu.fr/pcsc-tools-1.7.2.tar.bz2.asc
...
%setup -q -n pcsc-tools-1.7.2
cd %{_builddir}/pcsc-tools-1.7.2
pushd ..
cp -a pcsc-tools-1.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723476857
