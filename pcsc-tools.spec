...
Source0  : https://pcsc-tools.apdu.fr/pcsc-tools-1.7.3.tar.bz2
Source1  : https://pcsc-tools.apdu.fr/pcsc-tools-1.7.3.tar.bz2.asc
...
%setup -q -n pcsc-tools-1.7.3
cd %{_builddir}/pcsc-tools-1.7.3
pushd ..
cp -a pcsc-tools-1.7.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742762395
...
/usr/share/man/man1/gscriptor.1
/usr/share/man/man1/pcsc_scan.1
/usr/share/man/man1/scriptor.1
